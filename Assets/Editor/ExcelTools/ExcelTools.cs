...
namespace GameLogic.Editor
{
    public class ExcelTools
    {
        ...
        static readonly string scriptOutPutPath = "Assets/HotUpdate/Scripts/DataBase/AutoScript/";  // 脚本输出路径
        static readonly string dataOutPutPath = "Assets/HotUpdate/Resources/Datas/";                // 数据表输出路径
